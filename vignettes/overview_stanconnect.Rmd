...
- Indirect measure of buildup of amyloid (Pittsburgh Compound B)

--

- Indirect measure of neurodegeneration (Cortical thickness)

--

- Questionnaire on cognitive impairment

--

- Binary classification of dementia state
...
# Disease progression models II

![](overview_figs/progression.png)
...
- Underlying baseline hazard - same for all patients 
...
--
  ...
  - Does time reset after transition?
...
- **Forward algorithm**: Exact likelihood $P(Y_t, ... Y_1 | \theta)$ can be computed in
$\Theta(tK^2)$
